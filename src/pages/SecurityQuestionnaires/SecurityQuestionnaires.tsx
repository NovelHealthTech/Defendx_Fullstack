...
const questionnaires = [
	{
		id: 1,
		name: "CIS Critical Security Controls v8.1 - Implementation Group 3",
						...
						<table className="min-w-full text-sm">
							<thead>
								<tr className="text-muted-foreground border-b">
									...
									<th className="text-left py-2 px-4 font-normal">
										<PercentCircle className="inline w-4 h-4 mr-1" />
										% complete
									</th>
									<th className="text-left py-2 px-4 font-normal">
							...
							<tbody>
								{questionnaires.map((q) => (
									...
									>
										...
										<td className="py-2 px-4">{q.due}</td>
										...
										<td className="py-2 px-4">{q.score}</td>
										<td className="py-2 px-4">{q.risks}</td>
										<td className="py-2 px-4">
											{q.messages}
										</td>
									</tr>
